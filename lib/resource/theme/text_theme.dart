  ...
  static TextTheme _baseTextTheme(Color color) =>
      GoogleFonts.inconsolataTextTheme(Typography.blackCupertino).copyWith(
        ...
        headlineLarge: TextStyle().copyWith(
            fontSize: 32, fontWeight: FontWeight.bold, letterSpacing: 0.15),
        ...
        headlineSmall: TextStyle().copyWith(
            fontSize: 24, fontWeight: FontWeight.w500, letterSpacing: 0.1),
        titleLarge: TextStyle().copyWith(
            fontSize: 22, fontWeight: FontWeight.bold, letterSpacing: 0.0),
        titleMedium: TextStyle().copyWith(
            fontSize: 16, fontWeight: FontWeight.w500, letterSpacing: 0.0),
